const tokens = {
  ...
  "sizes.activitybar": {
    "value": "52px",
    "variable": "var(--sizes-activitybar)"
  },
  "sizes.statusbar": {
    "value": "24px",
    "variable": "var(--sizes-statusbar)"
  },
  "sizes.breakpoint-sm": {
    "value": "640px",
  ...
  "colors.bg.activity": {
    "value": "var(--colors-bg\\.activity)",
    "variable": "var(--colors-bg\\.activity)"
  },
  "colors.bg.sidebar": {
    "value": "var(--colors-bg\\.sidebar)",
    "variable": "var(--colors-bg\\.sidebar)"
  },
  "colors.bg.editor": {
    "value": "var(--colors-bg\\.editor)",
    "variable": "var(--colors-bg\\.editor)"
  },
  "colors.bg.statusbar": {
    "value": "var(--colors-bg\\.statusbar)",
    "variable": "var(--colors-bg\\.statusbar)"
  },
  "colors.bg.hover": {
  ...
  "colors.text.inverse": {
    "value": "var(--colors-text\\.inverse)",
    "variable": "var(--colors-text\\.inverse)"
  },
  "colors.text.muted": {
  ...
  "colors.icon.default": {
    "value": "var(--colors-icon\\.default)",
    "variable": "var(--colors-icon\\.default)"
  },
  "colors.icon.active": {
    "value": "var(--colors-icon\\.active)",
    "variable": "var(--colors-icon\\.active)"
  },
  ...
  "colors.accent.hover": {
    "value": "var(--colors-accent\\.hover)",
    "variable": "var(--colors-accent\\.hover)"
  },
  "colors.accent.active": {
    "value": "var(--colors-accent\\.active)",
    "variable": "var(--colors-accent\\.active)"
  },
  "colors.state.error.bg": {
    "value": "var(--colors-state\\.error\\.bg)",
    "variable": "var(--colors-state\\.error\\.bg)"
  },
  "colors.state.error.text": {
    "value": "var(--colors-state\\.error\\.text)",
    "variable": "var(--colors-state\\.error\\.text)"
  },
  "colors.state.error.border": {
    "value": "var(--colors-state\\.error\\.border)",
    "variable": "var(--colors-state\\.error\\.border)"
  },
  "colors.state.warning.bg": {
    "value": "var(--colors-state\\.warning\\.bg)",
    "variable": "var(--colors-state\\.warning\\.bg)"
  },
  "colors.state.warning.text": {
    "value": "var(--colors-state\\.warning\\.text)",
    "variable": "var(--colors-state\\.warning\\.text)"
  },
  "colors.state.warning.border": {
    "value": "var(--colors-state\\.warning\\.border)",
    "variable": "var(--colors-state\\.warning\\.border)"
  },
  "colors.state.success.bg": {
    "value": "var(--colors-state\\.success\\.bg)",
    "variable": "var(--colors-state\\.success\\.bg)"
  },
  "colors.state.success.text": {
    "value": "var(--colors-state\\.success\\.text)",
    "variable": "var(--colors-state\\.success\\.text)"
  },
  "colors.state.success.border": {
    "value": "var(--colors-state\\.success\\.border)",
    "variable": "var(--colors-state\\.success\\.border)"
  },
  "colors.state.info.bg": {
    "value": "var(--colors-state\\.info\\.bg)",
    "variable": "var(--colors-state\\.info\\.bg)"
  },
  "colors.state.info.text": {
    "value": "var(--colors-state\\.info\\.text)",
    "variable": "var(--colors-state\\.info\\.text)"
  },
  "colors.state.info.border": {
    "value": "var(--colors-state\\.info\\.border)",
    "variable": "var(--colors-state\\.info\\.border)"
  },
  "spacing.-1": {
